...
/// <summary>
/// The largest number we ask the user to guess, 
...
/// between 0 and the maximum number
/// </summary>
public void InformUser()
{
 // Ask user to think of a number
 //  between 0 and MaximumNumber
 Console.WriteLine($"I want you to think of a number" +
  $" between 0 and { this.MaximumNumber }. Ok?");
 Console.ReadLine();
}
/// <summary>
/// Asks the user a series of questions to 
/// discover the number they are thinking of
/// </summary>
...
Console.WriteLine($"Is your number between" +
    $" { this.CurrentGuessMinimum } and" +
    $" { this.CurrentGuessMaximum}?");
...
this.CurrentGuessMaximum = this.CurrentGuessMaximum
 - (this.CurrentGuessMaximum
 - this.CurrentGuessMinimum) / 2;
}
...
else
{
 ...
 int remainingDifference = this.MaximumNumber
     - this.CurrentGuessMaximum;
 // Set the guess max to half way 
 //between the guessMin and max
 // NOTE: Math.Ceiling will round up the 
 //remaining difference to 2, if the difference is 3
...
break;
 ...
 /// <summary>
 /// Annouces the number the user was
 /// thinking of and the number of guesses it took
 /// </summary>
